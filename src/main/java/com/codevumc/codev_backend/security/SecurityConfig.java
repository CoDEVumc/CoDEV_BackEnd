...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.httpBasic().disable()
                ...
                .antMatchers("/codev/my-page/**","/codev/project/**","/codev/study/**","/codev/user/update/password", "/codev/chat/**", "/codev/notification/**", "/codev/qnaBoard/**", "/codev/infoBoard/**", "/codev/board/**").authenticated()
